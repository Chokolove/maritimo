<template>
    <div class="flex -mx-2">
        <div class="w-1/2 h-auto px-5  mt-4">
            <span class="font-semibold text-xl tracking-tight">Lorem</span>
            <div>
                <br>
            </div>
  ...
  <div class="md:flex md:items-center mb-4">
    <div class="md:w-1/3">
      <label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="inline-coment">
        Mensaje
      </label>
    </div>
    <div class="md:w-2/3">
